...
- [ ] The test run was classified as `substantive` or `non_substantive`, and a render-only test with no output assertion counts as non-substantive
- [ ] Every fix applied is recorded with its category
